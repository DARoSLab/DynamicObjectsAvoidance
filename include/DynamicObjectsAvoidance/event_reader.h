#pragma once
// #ifndef DynamicObjectsAvoidance_EVENT_READER_H
// #define DynamicObjectsAvoidance_EVENT_READER_H
...
public:
	 ...
	 */
	explicit EventReader(const std::filesystem::path &aedat4FilePath, const std::string &cameraName);

	/**
	 * Construct a dv::io::CameraCapture equivalent.
	 * @param cameraName name of the camera to stram. Can be an empty string.
	 */
	explicit EventReader(const std::string &cameraName);
